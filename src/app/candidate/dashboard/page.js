...
useEffect(() => {
  async function fetchTranslationTasks() {
    try {
      ...
      const response = await fetch(`${baseURL}/api/employee/service/translation/`, {
        ...
        credentials: "include", // Optional: needed if you use cookies/sessions
      });
  ...
  return (
    <div className="min-h-screen p-6 bg-white dark:bg-gray-900 text-gray-900 dark:text-white  bg-gradient-to-br from-green-50 to-green-100 px-4">
